...
open class Boesewicht(name: String, lebenspunkte: Int, angriff: Int, verteidigung: Int, open val maxLebenspunkte: Int = 200) : Person(name, lebenspunkte, angriff, verteidigung) {
